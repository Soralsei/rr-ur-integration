...
class WorkspaceSampler():
    def __init__(self, frame, collision_service: str, kinematics_topic: str, n_points: Union[SupportsIndex, Sequence[SupportsIndex]], xrange: list, yrange: list, zrange: list, angle_cone: float = np.pi / 4, prefix: str = '', connect: bool = True):
        self.prefix = prefix
        self.seq = 0.0
        if len(n_points) == 1:
