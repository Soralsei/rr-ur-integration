...
class ArucoLocalizer:
    ...
    def _do_work(self) -> None:
        with self.marker_lock:
            ...
            self.marker_targets[:] = [marker for marker in self.marker_targets if self.is_older_than(marker, 5.0)]
            ...
            for marker in self.marker_targets:
                ...
                transforms.append(base_frame_to_target)
